...
export default class DatepickerView extends View {
	...
	render() {
		...
		this.listenTo( this.dateTimeInputView.element, 'selectstart', ( evt, domEvt ) => {
	...
	/**
	 * The native DOM `value` of the {@link #dateTimeInputView} element.
	 *
	...
	/**
	 * Sets the native DOM `value` of the {@link #dateTimeInputView} element.
	 *
	 * **Note**: Do not confuse it with the {@link module:ui/inputtext/inputtextview~InputTextView#value}
	 * which works one way only and may not represent the actual state of the component in the DOM.
	 *
	...
	isValid() {
		...
		for ( const validator of this._validators ) {
			...
			if ( errorText ) {
				// Apply updated error.
				this.dateTimeInputView.errorText = errorText;
	...
	/**
	 * Cleans up the supplementary error and information text of the {@link #dateTimeInputView}
	 * bringing them back to the state when the form has been displayed for the first time.
	 *
	 * See {@link #isValid}.
	 */
	resetFormStatus() {
		this.dateTimeInputView.errorText = null;
	}
